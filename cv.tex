...
\begin{document}
\makeheading{Nicholas R. Hood {\footnotesize BSc (Hons)(Open), MRAeS, MInstP, CPhys, CSci \hfill  \href{mailto:nick@cullaloe.com}{nick@cullaloe.com}\\
55 Selvage Street, Rosyth, Fife, KY11 2QE \hspace{1cm} +44 (0)7702 072652 \hfill \url{http://cullaloe.com/}}}

\section{Synopsis}
Educator, physicist and software engineer. Broad and extensive experience of internet technologies and data-driven web solutions. International track record in Education, IT, Project Management, Simulation and Training. Excellent interpersonal and communication skills at all levels.
...
%\blankline
\begin{wrapfigure}{r}{0.3\textwidth}     \includegraphics[width=0.3\textwidth]{MCSD_logo}\end{wrapfigure}
...
%\item[] \textit{Teacher of Physics \& Mathematics (Kirkcaldy)}               \hfill \textbf{April 2010 to July 2012}
\item[] \textit{Principal Teacher, Physics (Glenwood HS) }   %    \hfill \textbf{May 2008 to April 2010}
\item[] \textit{Teacher of Physics \& Mathematics (Kirkcaldy HS)}  %      \hfill \textbf{August 2005 to April 2008}
\item[] \textit{Teacher of Physics \& Mathematics (Probationer, Buckhaven HS)}  %    \hfill \textbf{August 2004 to July 2005}
\end{outerlist}
