...
\begin{document}
\makeheading{Nicholas (Nick) R. Hood {\footnotesize BSc (Hons)(Open), CPhys, CSci, MInstP, MRAeS, FRSA, LRPS \\ \href{mailto:nick@cullaloe.com}{nick@cullaloe.com} \hfill \the\month/\the\year}}
