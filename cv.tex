...
\section{Education}
% = = = = = = = = = = = = = = =
{\textbf{Edinburgh University} Moray House} PGCE (Physics and Mathematics), July 2004\\
{\textbf{The Open University}} B.Sc. (Hons), November 2002
...
%
\textbf{The General Teaching Council for Scotland} {\footnotesize Physics, July 2005; Mathematics, April 2006}
\begin{wrapfigure}{r}{0.2\textwidth}     \includegraphics[width=0.2\textwidth]{MCSD_logo}\end{wrapfigure}
\textbf{The Institute of Physics} FInstP, July 2022\\
\textbf{The Institute of Physics} MInstP, CPhys, July 2003 \\
\textbf{The Science Council} Chartered Scientist (CSci), July 2004\\
\textbf{The Microsoft Corporation} MCSD, June 2001\\
\textbf{The Royal Aeronautical Society} MRAeS, August 1999\\
\textbf{The Royal Photographic Society} LRPS, February 2020
...
\section{}
% = = = = = = = = = = = = = = =
\textbf{cullaloe.net} \textit{trading as Al Muhandis}, Fife        \hfill \textbf{April 2003 to August 2016}
...
% = = = = = = = = = = = = = = =
\begin{innerlist}
\item Fellow of the Institute of Physics, 2022
